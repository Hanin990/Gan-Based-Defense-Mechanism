...
class ProgramArgs(argparse.Namespace):
    def __init__(self):
        ...
        self.wandb_project =  "GAN-Training-1" 
        self.wandb_entity =  "hanin3" 
        self.wandb_name =  "hard" 
        ...
        # path parameters
        self.workspace = '/notebooks/Gan-Based-Defense-Mechanism'
        ...
        self.nbr_file = '/notebooks/Gan-Based-Defense-Mechanism/formatted_arabic_word_relationships.json' 
        ...
        # tmd args
        self.gm = "infogan"
        self.gm_path = "path to infogan trained model"
        self.tmd_layer = -1
        self.start_index = 0
        self.end_index = None
        self.method = 4
