...
class ProgramArgs(argparse.Namespace):
    def __init__(self):
        ...
        self.wandb_project =  "ASCC-Training-1" 
        self.wandb_entity =  "abdul3" 
        self.wandb_name =  "brad" 
        self.wandb_tags = "ascc" "alpha = 4" "beta = 10"
        self.resume_training = 'False'

        # attack parameters
        self.attack_method = 'pwws'
        self.attack_times = 1
        self.attack_numbers = 1400
        # attack constraint args defined by us
        self.modify_ratio = 0.2
        self.neighbour_vocab_size = 10
        self.sentence_similarity = 0.840845057
        self.query_budget_size = self.neighbour_vocab_size

        # path parameters
        self.workspace = '/notebooks/Textual-Manifold-Based-Attack/TextDefender'
        ...
        self.nbr_file = '/notebooks/Textual-Manifold-Based-Attack/TextDefender/formatted_arabic_word_relationships.json' 
        ...
        self.get_file_creation_time = datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")
        # tmd args
        self.gm = "infogan"
        self.gm_path = "/notebooks/Textual-Manifold-Based-Attack/output_hard_nov-25/infogan_bert_hard/lightning_logs/z5aiwa5t/checkpoints/infogan-epoch=16-validate_rec_loss=0.00.ckpt"
        #self.gm_path = "/notebooks/Textual-Manifold-Based-Attack/outputs_brad/infogan_bert_brad/lightning_logs/20i7ubxw/checkpoints/epoch=106-step=106251.ckpt"
        self.tmd_layer = -1
        self.start_index = 0
        self.end_index = None
        self.method = 4
