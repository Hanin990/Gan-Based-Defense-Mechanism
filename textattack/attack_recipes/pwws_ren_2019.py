...
from textattack.search_methods import GreedyWordSwapWIR, GreedyWordSwapWIRPWWS, BeamSearch, GreedySearch
from textattack.shared.attack import Attack
from textattack.transformations import WordSwapWordNet, RandomSwap
...
class PWWSRen2019(AttackRecipe):
    ...
    def build(model, ensemble: bool = False):
        print("pwws build inside")
        # transformation = RandomSwap()
        transformation = WordSwapWordNet()
        print("transss++++++++++++++++", transformation)
