# Updated from the file infromation below.
#-----------------------------------------------------------------------------
...
def processCmdlineOpts(cmdOpts):
    ...
    if not opts.__contains__('i'):
        opts['i']='/notebooks/Textual-Manifold-Based-Attack/TextDefender/textattack/transformations/awn2-no-tashkeel.xml'
        #opts['i']='/content/drive/MyDrive/classification_arab_turk/Classification_NLP/fgws-main/awn.xml'
    return opts
...
# i replaced has.key with __contains__ 
# i added rb to the open file function to make binary in line 369
