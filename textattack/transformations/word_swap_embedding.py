...
"""
from textattack.shared import AbstractWordEmbedding, WordEmbedding, GensimWordEmbedding
    ...
    def __init__(
        ...
        **kwargs
        ...
        if embedding is None:
            embedding_path = "embeddng model fasttext or w2vec"
            embedding = GensimWordEmbedding(embedding_path)
