"""
We employed TextAttack, a popular adversarial NLP framework, to conduct robustness 
experiments in our study. TextAttack facilitates efficient generation and evaluation of 
adversarial examples and provides modular components for text transformations and model interaction.
"""
