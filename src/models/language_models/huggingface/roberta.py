# Code drived from the same implementation used in
# "Textual Manifold-based Defense Against Natural Language Adversarial Examples".
# But we didnt apply this model. 
...
class Roberta(HuggingFaceLanguageModel, RobertaForSequenceClassification):
    ...
    def classify_embs(self, pooled_output):
        ...
        pooled_output = pooled_output.unsqueeze(1)  # (bs, 1, dim) (to match the input dim of the classifier)
